...
final class GCM: BlockMode {
    ...
    let options: BlockModeOption = [.initializationVectorRequired, .useEncryptToDecrypt]
    ...
    // encrypt
    init(iv: Array<UInt8>, additionalAuthenticatedData: Array<UInt8>? = nil, mode: Mode = .detached) {
        self.iv = iv
