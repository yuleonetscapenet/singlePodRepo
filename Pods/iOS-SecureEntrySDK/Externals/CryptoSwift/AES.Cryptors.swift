...
extension AES: Cryptors {
    func makeEncryptor() throws -> AES.Encryptor {
        return try AES.Encryptor(aes: self)
    }

    func makeDecryptor() throws -> AES.Decryptor {
...
extension AES {
    struct Encryptor: Cryptor, Updatable {
...
extension AES {
    struct Decryptor: RandomAccessCryptor, Updatable {
        private var worker: BlockModeWorker
        private let padding: Padding
