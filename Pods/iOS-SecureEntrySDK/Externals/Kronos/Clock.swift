...
struct Clock {
    ...
    static var storage = TimeStorage()
    ...
    /// - parameter first:      A closure that will be called after the first valid date is calculated.
     static func sync(from pool: String = ClockConstants.TimePools.Apple, samples: Int = 4,
 ...
 struct ClockConstants {
     struct TimePools {
         static let Apple = "time.apple.com"
         static let Google = "time.google.com"
         static let Microsoft = "time.microsoft.com"
    }
}
